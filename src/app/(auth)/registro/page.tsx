  ...
  if (isSuccess) {
    return (
      <div className="w-full max-w-sm">
        <div className="border border-dark-muted/40 rounded-2xl bg-surface-dark/50 backdrop-blur-sm p-8 md:p-10 text-center">
          {/* Logo */}
          ...
          <p className="text-sm text-gray-muted mb-8">
            Hemos enviado un correo como último paso para que actives tu cuenta.
          </p>

          <Link
            href="/login"
            className="inline-block w-full bg-brand-primary hover:bg-brand-primary/90 text-black font-semibold py-3 px-4 rounded-lg transition-colors text-sm lg:text-base text-center"
          >
            Ir a Iniciar Sesión
          </Link>
        </div>
    ...
    <div className="w-full max-w-sm">
      <div className="border border-dark-muted/40 rounded-2xl bg-surface-dark/50 backdrop-blur-sm p-8 md:p-10">
        ...
        <button className="cursor-pointer w-full bg-surface-dark border border-dark-muted/40 hover:border-dark-muted/60 text-white py-3 px-4 rounded-lg font-semibold transition-colors flex items-center justify-center gap-3 mb-6">
          ...
          <span className="text-sm">Registrarme con Google</span>
        </button>
        ...
        <div className="text-center mt-6 text-xs lg:text-sm">
          <span className="text-gray-muted">¿Ya tienes cuenta? </span>
          <Link
            href="/login"
